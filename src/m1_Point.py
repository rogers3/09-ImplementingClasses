...
# -----------------------------------------------------------------------------
# DPME: 2.          With your instructor, READ THE INSTRUCTIONS in
# DPME (continued)  in file  m0_INSTRUCTIONS.txt, asking questions as needed.
#
...
class Point(object):
    ...
    def halfway_to(self, p1):
        return Point(abs(p1.x+((self.x-p1.x)/2)), abs(p2.y+(self.y-p1.y)/2))
...
def run_test_get_number_of_moves_made():
    ...
    # DPME (continued):  HINT: What must a Point REMEMBER for this method?
    # -------------------------------------------------------------------------
    print()
    print('-----------------------------------------------------------')
